...
Technically speaking, the GM grade is still within the designed space of the TGM series (there is an in-game rank for it after all), but it's so far beyond the normal play experience that, to me, it feels similar to the things I listed above.
