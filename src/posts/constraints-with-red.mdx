...
```
- [🔴 required] We need a single source of truth for our product data
- [🔴 required] Cost of server resources must stay within the budget projections for this quarter
- [🟡 expected] We can integrate our data storage with external tools and systems if we need to, to pull in any contextual information that they might store
- [🟡 expected] Our system can export data to CSV format
- [🔵 desired] Our system can export product data directly to external systems, like our CRM
- [🔵 desired] Inlucde some kind of tracking or audit system that shows who inputted what data into the system
```
